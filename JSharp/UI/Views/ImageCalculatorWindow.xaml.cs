        ...
        private void BtnConfirm_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (fileName1 == null || fileName2 == null || stringOperation == null)
            {
                throw new InvalidOperationException(
                    $"Expected both image selections and an operation to be selected, got ('{fileName1}', '{fileName2}', '{stringOperation}').");
            }
            ...
            if (operation == OperationType.BLEND)
            {
                ...
                {
                    throw new ArgumentException($"Invalid blend factor: '{TxtBlendFactor.Text}'.");
                }
            }
            else
            {
            ...
            (DataContext as ImageCalculatorWindowViewModel)?.Confirm(fileName1, fileName2, operationData, shouldCreateNewWindow);
        }
