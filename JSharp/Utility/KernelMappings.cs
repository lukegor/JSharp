...
namespace JSharp.Utility
{
    public class KernelMappings
    {
        ...
        public static Dictionary<string, int[,]> KernelNameToArray { get; } = new Dictionary<string, int[,]>
        {
            ...
            {Kernels.PrewittN, new int[,] { { -1, -1, -1 }, { 1, -2, 1 }, { 1, 1, 1 } }},
            {Kernels.PrewittNE, new int[,] { { 1, -1, -1 }, { 1, -2, -1 }, { 1, 1, 1 } }},
            {Kernels.PrewittE, new int[,] { { 1, 1, 1 }, { 1, -2, -1 }, { 1, 1, -1 } }},
            {Kernels.PrewittSE, new int[,] { { 1, 1, 1 }, { 1, -2, -1 }, { 1, -1, -1 } }},
            {Kernels.PrewittS, new int[,] { { 1, 1, 1 }, { 1, -2, 1 }, { -1, -1, -1 } }},
            {Kernels.PrewittSW, new int[,] { { 1, 1, 1 }, { -1, -2, 1 }, { -1, -1, 1 } }},
            {Kernels.PrewittW, new int[,] { { -1, 1, 1 }, { -1, -2, 1 }, { -1, 1, 1 } }},
            {Kernels.PrewittNW, new int[,] { { -1, -1, 1 }, { -1, -2, 1 }, { 1, 1, 1 } }},
